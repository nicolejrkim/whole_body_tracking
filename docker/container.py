...
def parse_cli_args() -> argparse.Namespace:
    ...
    parent_parser.add_argument(
        "--name",
        default="whole-body-tracking",
        help="Container name specification. Example: 'whole-body-tracking'.",
    )
    parent_parser.add_argument(
        "--profile",
        nargs="?",
        default="",
        help="Optional container profile specification. Example: 'dev' or 'osmo'.",
    )
    parent_parser.add_argument(
        "--files",
        nargs="*",
    ...
    subparsers.add_parser("build", help="Build the docker image.", parents=[parent_parser])
...
def main(args: argparse.Namespace):
    ...
    print(f"[INFO] Using container name: {ci.name}")
